...
// 일반 함수에서의 this는 global 객체를 참조한다.
const testFunction = function(){
    return this;
}

console.log(testFunction()); // global 객체
...
console.log(yuJin2.dance());
// undefined이 춤을춥니다.
// 객체의 상위 레벨에 메서드로 this를 사용하면 객체가 매핑되지만 그렇지 않으면 this가 global에 매핑된다.
...
console.log(returnName()); // undefined, global.name은 undefined 이므로...
