...
const multiplyAll = function (...arguments) {
    console.log(arguments); // [3, 4, 5, 6, 7, 8, 9, 10]
    console.log(Object.values(arguments)) // [3, 4, 5, 6, 7, 8, 9, 10]
    console.log(arguments.reduce((a, b) => a * b, 1)) // 1814400
    return Object.values(arguments).reduce((a, b) => a * b, 1); // 1814400
}
...
// Arrow Function으로 즉시실행 함수 만들기
((x, y) => {console.log(x + y)})(1, 1);
